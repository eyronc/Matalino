...
export default function LessonContents({data}) {
  return (
    <>
      <div className="space-y-10">
        <div className="flex items-end justify-between">
          ...
          <div className="hidden md:flex items-center gap-2 text-sm text-gray-500">
            <span>{data.length} pathways</span>
          </div>
        </div>
      ...
      <div className="space-y-10">
        <div className="flex items-end justify-between">
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900">Custom lessons</h2>
            <p className="mt-2 text-gray-600">
          ...
          <div className="relative overflow-hidden bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 border-2 border-dashed border-indigo-200 rounded-3xl p-12 text-center">
            <div className="relative z-10">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Generate a personalized lesson from the dashboard to see it
                appear here.
              </p>
