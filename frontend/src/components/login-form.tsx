      ...
      <Card className="w-full max-w-5xl min-h-[600px] max-h-[95vh] border-0 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-xl bg-white/95 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <CardContent className="grid p-0 md:grid-cols-2 h-full min-h-[600px]">
          ...
          <div className="hidden md:flex flex-col justify-between bg-linear-to-br from-[#0066ff] to-[#7c3aed] p-8 md:p-10 relative overflow-y-auto">
            ...
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full py-2 px-4 relative z-10 hover:bg-white/15 transition-all animate-in slide-in-from-left duration-700 delay-500 flex-shrink-0 mt-4">
