...
export function LoginForm({
  ...
  return (
    <div className={cn("fixed inset-0 w-full h-full flex items-center justify-center p-4 md:p-6", className)} {...props} style={{ fontFamily: "'Inter', sans-serif", background: 'linear-gradient(to bottom right, #0f172a, #1e3a8a, #5b21b6)' }}>
      ...
      <Card className="w-full max-w-5xl border-0 shadow-2xl rounded-3xl overflow-hidden relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700" style={{ backgroundColor: 'transparent', height: 'auto', maxHeight: '90vh' }}>
        <CardContent className="grid p-0 md:grid-cols-2 h-full">
          {/* Left Panel */}
          <div className="hidden md:flex flex-col justify-between p-8 relative overflow-hidden" style={{ background: 'linear-gradient(to bottom right, #0066ff, #7c3aed)' }}>
          ...
          <form className="p-5 md:p-6 lg:p-7 bg-white flex flex-col overflow-y-auto" style={{
            ...
            <FieldGroup className="space-y-2.5 animate-in slide-in-from-right duration-700 max-w-md mx-auto w-full my-auto">
              <div className="flex md:hidden items-center justify-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg cursor-pointer" style={{ background: 'linear-gradient(to bottom right, #0066ff, #7c3aed)' }}>
                  <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                    <path d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              ...
              <div className="mb-3">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1.5" style={{ fontWeight: 700 }}>Sign In</h1>
              ...
              <Field>
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    required
                    className="relative h-11 bg-gray-50 border-2 border-gray-200 focus:bg-white focus:border-[#0066ff] focus:ring-2 focus:ring-[#0066ff]/20 rounded-xl transition-all px-4 hover:border-gray-300 cursor-text"
