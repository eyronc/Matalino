...
export function LoginForm({ setPage, className, ...props }: LoginFormProps) {
  return (
    <div className={cn("fixed inset-0 w-full h-full flex items-center justify-center p-4", className)} {...props} style={{ fontFamily: "'Inter', sans-serif", background: 'linear-gradient(to bottom right, #0f172a, #1e3a8a, #5b21b6)' }}>
      ...
      <Card className="w-full max-w-5xl border-0 shadow-2xl rounded-3xl overflow-hidden relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700" style={{ backgroundColor: 'transparent' }}>
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col justify-between p-8 lg:p-10 relative overflow-hidden rounded-l-3xl" style={{ background: 'linear-gradient(to bottom right, #0066ff, #7c3aed)' }}>
            ...
            <div className="space-y-3 relative z-10">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 flex items-center gap-3 hover:bg-white/15 transition-all hover:scale-105 animate-in slide-in-from-left duration-700 delay-300 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>Real-time analytics</p>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 flex items-center gap-3 hover:bg-white/15 transition-all hover:scale-105 animate-in slide-in-from-left duration-700 delay-400 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>Smart flashcards</p>
                </div>
              </div>
            </div>

            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full py-2 px-4 relative z-10 hover:bg-white/15 transition-all animate-in slide-in-from-left duration-700 delay-500">
          ...
          <form className="login-scroll-form p-8 lg:p-10 bg-white flex flex-col overflow-y-auto rounded-r-3xl" style={{
            scrollbarWidth: 'thin',
            scrollbarColor: '#0066ff #e5e7eb'
          }}>
            <FieldGroup className="space-y-4 animate-in slide-in-from-right duration-700 max-w-md mx-auto w-full">
              <div className="flex md:hidden items-center justify-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-lg cursor-pointer" style={{ background: 'linear-gradient(to bottom right, #0066ff, #7c3aed)' }}>
                  <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                    <path d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <span className="text-xl font-bold bg-clip-text text-transparent" style={{ fontFamily: "'Inter', sans-serif", background: 'linear-gradient(to right, #0066ff, #7c3aed)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Matalino</span>
              </div>
              ...
              <Field>
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    required
                    className="relative h-11 bg-gray-50 border-2 border-gray-200 focus:bg-white focus:border-[#0066ff] focus:ring-2 focus:ring-[#0066ff]/20 rounded-xl transition-all px-4 hover:border-gray-300 cursor-text text-sm"
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-white px-3 text-sm text-gray-500" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>Or continue with</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button 
                  variant="outline" 
                  type="button"
                  className="h-11 border-2 border-gray-200 hover:border-[#0066ff] hover:bg-blue-50 rounded-xl transition-all transform hover:scale-105 active:scale-95 cursor-pointer"
                >
              ...
              <div className="text-center text-gray-600 text-sm pt-2">
                ...
                <button 
                  ...
                  className="text-[#0066ff] hover:text-[#0052cc] font-semibold transition-colors cursor-pointer hover:underline"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  Sign up
                </button>
