...
export function SignupForm({
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-6 min-h-screen items-center justify-center p-4 bg-linear-to-br from-[#f5f5f7] to-[#efefef]",
        className
      )}
      {...props}
    >
      <Card className="overflow-hidden border-0 shadow-2xl max-w-5xl w-full rounded-3xl">
        <CardContent className="grid p-0 md:grid-cols-2 min-h-125">
            ...
            <FieldGroup className="space-y-6">
              ...
              <div className="flex flex-col items-center md:items-start gap-3 mb-4">
                ...
                <div className="text-center md:text-left">
                  <h1 className="text-3xl md:text-4xl font-bold text-[#1d1d1f] mb-1 bg-linear-to-r from-[#8B7EFF] to-[#6A5ADF] bg-clip-text">
                    Join Matalino
                  </h1>
              ...
              <Field>
                <FieldLabel
                  htmlFor="email"
                  className="text-[#6e6e73] font-semibold text-xs uppercase tracking-wider mb-3 block"
                >
                  Email Address
                </FieldLabel>
                <Input
              ...
              <Field>
                ...
                <FieldDescription className="text-[#86868b] text-xs mt-2">
              ...
              <FieldSeparator className="my-6">
                <span className="text-[#86868b] text-xs font-semibold uppercase tracking-widest px-3 bg-white">
                  Or continue with
                </span>
              </FieldSeparator>
              ...
              <Field className="grid grid-cols-3 gap-3">
                ...
                <Button
                  variant="outline"
                  type="button"
                  className="h-11 border-2 border-[#e8e8ed] hover:border-[#8B7EFF] hover:bg-[#d1c4e9] rounded-xl transition-all group cursor-pointer"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className="w-5 h-5 text-[#1d1d1f] group-hover:scale-110 transition-transform"
                  >
                    <path
          ...
          <div className="bg-linear-to-br from-[#8B7EFF] via-[#6A5ADF] to-[#5B4B9A] relative hidden md:flex flex-col items-center justify-center p-8 overflow-hidden">
            {/* Gradient blobs */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#A89DFF]/50 rounded-full blur-3xl animate-pulse" />
            <div
              className="absolute bottom-0 left-0 w-80 h-80 bg-[#6A5ADF]/40 rounded-full blur-3xl animate-pulse"
            ...
            <div className="relative z-10 w-full max-w-md space-y-8">
              <div className="space-y-3 text-white">
                ...
                <p className="text-purple-100 text-sm font-medium">
                  Join thousands of students mastering exams with AI.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/30 rounded-2xl p-4 flex items-center gap-3 hover:bg-white/20 transition-all cursor-pointer group">
                  ...
                  <div>
                    <p className="text-white font-bold text-sm">Spaced Repetition</p>
                    <p className="text-purple-100 text-xs">Optimized review scheduling</p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/30 rounded-2xl p-4 flex items-center gap-3 hover:bg-white/20 transition-all cursor-pointer group">
                  ...
                  <div>
                    <p className="text-white font-bold text-sm">AI Explanations</p>
                    <p className="text-purple-100 text-xs">Clear answers in seconds</p>
                  </div>
                </div>
              </div>
              ...
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/30 py-3 px-4 rounded-full hover:bg-white/15 transition-all">
                ...
                <p className="text-xs font-bold text-white">+12k students already joined</p>
              </div>
            </div>
          </div>
        </CardContent>
