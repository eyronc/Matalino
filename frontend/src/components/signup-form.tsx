//signup-form (need to make it shorter and more concise, also add some animations and make it more visually appealing)
...
export function SignupForm({
  ...
  return (
    <div className={cn("min-h-screen flex items-center justify-center p-0 bg-linear-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] relative overflow-hidden", className)} {...props}>
      ...
      <Card className="w-full max-w-6xl border-0 shadow-none rounded-none overflow-hidden relative z-10 animate-in fade-in duration-700">
        <CardContent className="grid p-0 md:grid-cols-5 min-h-175">
          {/* Left Sidebar - Decorative Panel */}
          <div className="hidden md:flex flex-col bg-linear-to-br from-[#ff006e] via-[#8338ec] to-[#3a0ca3] p-10 relative overflow-hidden col-span-2">
          ...
          <form className="p-8 md:p-12 bg-white flex flex-col justify-center col-span-3 relative overflow-y-auto">
            ...
            <FieldGroup className="space-y-5 relative z-10 max-w-md mx-auto w-full py-6">
              {/* Mobile Logo */}
              <div className="flex md:hidden items-center justify-center gap-3 mb-6">
                <div className="w-12 h-12 bg-linear-to-br from-[#ff006e] to-[#8338ec] rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <Field>
                ...
                <div className="relative group">
                  <div className="absolute inset-0 bg-linear-to-r from-[#ff006e] to-[#8338ec] rounded-2xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300" />
                  <Input
                    id="fullname"
                    type="text"
                    placeholder="John Doe"
                    required
                    className="relative h-14 bg-gray-50 border-2 border-gray-200 focus:bg-white focus:border-[#ff006e] focus:ring-4 focus:ring-[#ff006e]/10 rounded-2xl transition-all text-base px-5 hover:border-gray-300"
                  />
                </div>
              </Field>
              ...
              <div className="flex items-start gap-2">
                <input 
                  ...
                  id="terms" 
                  required
                  className="w-5 h-5 text-[#ff006e] border-2 border-gray-300 rounded-md focus:ring-[#ff006e] focus:ring-2 cursor-pointer mt-0.5 transition-all"
                />
              ...
              <Button 
                type="submit" 
                className="w-full h-14 bg-linear-to-r from-[#ff006e] to-[#8338ec] hover:from-[#e6005c] hover:to-[#6d28d9] text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] active:scale-95 text-base mt-2"
              >
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <Button 
                  variant="outline" 
                  type="button"
                  className="h-14 border-2 border-gray-200 hover:border-[#ff006e] hover:bg-pink-50 rounded-2xl transition-all group transform hover:scale-105 active:scale-95"
                >
              ...
              <FieldDescription className="text-center text-gray-600 text-base pt-4">
                ...
                <button 
                  ...
                  className="text-[#ff006e] hover:text-[#e6005c] font-bold transition-all hover:underline"
                >
                  Sign in
                </button>
              </FieldDescription>
              ...
              {/* Security Badge */}
              <div className="flex items-center justify-center gap-4 pt-4 border-t-2 border-gray-200 mt-4">
